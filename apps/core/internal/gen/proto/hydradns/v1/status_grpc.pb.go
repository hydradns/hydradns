...
const (
	DataPlaneStatusService_GetStatus_FullMethodName        = "/hydradns.v1.DataPlaneStatusService/GetStatus"
	DataPlaneStatusService_SetAcceptQueries_FullMethodName = "/hydradns.v1.DataPlaneStatusService/SetAcceptQueries"
)
...
func (UnimplementedDataPlaneStatusServiceServer) SetAcceptQueries(context.Context, *SetAcceptQueriesRequest) (*SetAcceptQueriesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SetAcceptQueries not implemented")
}
...
func RegisterDataPlaneStatusServiceServer(s grpc.ServiceRegistrar, srv DataPlaneStatusServiceServer) {
	// If the following call panics, it indicates UnimplementedDataPlaneStatusServiceServer was
...
var DataPlaneStatusService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "hydradns.v1.DataPlaneStatusService",
	...
	Metadata: "hydradns/v1/status.proto",
}
